            ...
            <div>
              ...
              <div style={{ position: "relative" }}>
                ...
                <input
                  type="email"
                  required
                  name="combrain_admin_email_field"
                  id="combrain_admin_email_field"
                  autoComplete="off"
                  value={email}
                  onChange={(e) => setEmail(e.target.value)}
                  placeholder="admin@combrain.com"
            ...
            <div>
              ...
              <div style={{ position: "relative" }}>
                ...
                <input
                  ...
                  required
                  name="combrain_admin_password_field"
                  id="combrain_admin_password_field"
